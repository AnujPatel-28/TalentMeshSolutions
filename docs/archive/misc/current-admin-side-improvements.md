...
for the ux  wise also it should be easy for the admin to find things and manage things , and it should be clean and simple and easy to use , intuitive and fast to respond , for the ui and ux we can use the UI SKILL folder in the directory
